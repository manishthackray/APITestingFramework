...
public class TestConfig{
	...
	public static String from = "mptest497@gmail.com";
	public static String password = "aladdin@497";
	public static String[] to ={"mptest497@gmail.com","manishpatil497@gmail.com"};
